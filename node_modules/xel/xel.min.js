...
let {isFinite: isFinite$2, isNaN, parseFloat: parseFloat$2} = Number;
...
class XSwitchElement extends HTMLElement {
  ...
  _updateAccessabilityAttributes() {
    ...
    if (this.disabled) {
      this[$oldTabIndex$10] = (this.tabIndex > 0 ? this.tabIndex : 0);
      this.tabIndex = -1;
    }
    else {
      if (this.tabIndex < 0) {
        this.tabIndex = (this[$oldTabIndex$10] > 0) ? this[$oldTabIndex$10] : 0;
      }

      delete this[$oldTabIndex$10];
    }
  }
...
class XTagInputElement extends HTMLElement {
  ...
  _updateAccessabilityAttributes() {
    ...
    if (this.disabled) {
      this[$oldTabIndex$11] = (this.tabIndex > 0 ? this.tabIndex : 0);
      this.tabIndex = -1;
    }
    else {
      if (this.tabIndex < 0) {
        this.tabIndex = (this[$oldTabIndex$11] > 0) ? this[$oldTabIndex$11] : 0;
      }

      delete this[$oldTabIndex$11];
    }
  }
...
class XTextareaElement extends HTMLElement {
  ...
  _updateAccessabilityAttributes() {
    ...
    if (this.disabled) {
      this[$oldTabIndex$12] = (this.tabIndex > 0 ? this.tabIndex : 0);
      this.tabIndex = -1;
    }
    else {
      if (this.tabIndex < 0) {
        this.tabIndex = (this[$oldTabIndex$12] > 0) ? this[$oldTabIndex$12] : 0;
      }

      delete this[$oldTabIndex$12];
    }
  }
